public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: The Dequeue method was trying to remove data at index [1] instead of [0]
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: The enqueue was inserting at index [0] of the queue instead of the end
        ...
        // Defect(s) Found: Everything works
    }
